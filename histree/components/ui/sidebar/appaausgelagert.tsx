    ...
    <Sidebar>
      ...
      <SidebarContent>
        ...
        <Collapsible title="Scaling" className="group/collapsible">
          <SidebarGroup>
            <SidebarGroupLabel asChild className="group/label text-sm group-data-[state=open]/collapsible:bg-gray-500 
        group-data-[state=open]/collapsible:transition-colors 
        group-data-[state=open]/collapsible:duration-200
        group-data-[state=open]/collapsible:mb-5 ">
              <CollapsibleTrigger className="flex w-full justify-between">
                Scaling
                <ChevronRight className="ml-auto transition-transform group-data-[state=open]/collapsible:rotate-90" />
              </CollapsibleTrigger>
            ...
            <CollapsibleContent>
              <SidebarGroupContent className="flex flex-col space-y-4 ml-2 mb-2">
        ...
        {/* EVENT FILTER */}
        <Collapsible title="Event Filter" className="group/collapsible">
          <SidebarGroup>
            <SidebarGroupLabel asChild className="group/label text-sm">
              <CollapsibleTrigger className="flex w-full justify-between">
                Event Filter
